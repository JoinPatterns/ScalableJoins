...
%% The \sjoins\ library contains the \cjoin\ class.
...
%% well as their effects are declared using \emph{join patterns} (also known as \emph{chords}):
...
%the join pattern is \emph{redundant}, 
